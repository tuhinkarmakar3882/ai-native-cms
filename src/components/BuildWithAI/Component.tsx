...
import { EnumValues, IGenAIBlockGenerator } from '@/generator/types'
...
interface IBuildWithAIProps {
  blockType: EnumValues<typeof BlockType>
  config?: any
}

export const BuildWithAI = ({ blockType = BlockType.RichTextContent }: IBuildWithAIProps) => {
  ...
  return (
    <StyledBuildWithAIContainer>
      <Button className="trigger-button" onClick={() => setModalVisibility(!isModalVisible)}>
        ...
        Scaffold Page with AI Generated Content
      </Button>
