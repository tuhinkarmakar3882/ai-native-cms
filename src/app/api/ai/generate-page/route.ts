...
- Prefer fewer blocks. Aim for 3–6 blocks for a landing page; 2–4 for docs/articulation pages. Respect constraints.maxBlocks if provided.
...
- Score candidate blocks 1–5 and include only >=4.
...
export async function POST(req: Request) {
  ...
  const result = await model.generateContent({
    contents: [{ role: 'user', parts: [{ text: SystemPromptForPlanning + '\n' + prompt }] }],
